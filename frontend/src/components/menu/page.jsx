...
const Menu = () => {
  const CLIENT_ID = "Ov23liKP0nICwlSHOWxx";
  ...
  useEffect(() => {
    ...
    if (sessionStorage.getItem("code") && storedData === null) {
      async function getAccessToken() {
        await fetch(
          "http://localhost:4000/getAccessToken?code=" + codeParams, // Updated port to 4000
          {
            method: "GET",
          }
        )
        ...
        await fetch("http://localhost:4000/getUserData", { // Updated port to 4000
          method: "GET",
          headers: {
            Authorization:
  ...
  const handleSignOut = () => {
    ...
    setReRender(!reRender); // Trigger re-render to update UI
  };
